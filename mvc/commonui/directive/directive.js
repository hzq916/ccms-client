...
angular.module('cmsDirective').directive('cmsGuide',function() {
	return {
		restrict: 'E',
 		templateUrl: '../commonui/directive/cms-guide.html',
 	 	replace: false,
		scope : {
			guideData:'@',
			guideShowid: '@',
...
/*
输入过滤器
给input 添加 cms-mask = "regType", regType 分为: unsignedInt , int , unsignedFloat , float, word
*/
angular.module('cmsDirective').directive('cmsMask', function() {
	return {
		restrict: "A",
		require: "?ngModel",
