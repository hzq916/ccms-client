angular.module('cmsController').controller('fundsDataSynchronizeCtrl',function($scope,$timeout,$rootScope,$ocLazyLoad,mainService,fundsDataSynchronizeServeice) {
	$scope.templateMenuList = [];
	$scope.templateSettingOpenMenuList = [];

	$scope.fundsDataSynchronizeInit = function() {
		...
		* cssPath: css路径
		*/
		$scope.templateMenuList.push({id:2005004001,title:"数据同步",select:false,show:true,pagePath:"../fundsDataSynchronize/fundsDataSync/fundsDataSync.html",controllerPath:"../fundsDataSynchronize/fundsDataSync/fundsDataSyncCtrl.js",servicePath:"../fundsDataSynchronize/fundsDataSync/fundsDataSyncService.js",cssPath:"../fundsDataSynchronize/fundsDataSync/fundsDataSync.css"});
        $scope.templateMenuList.push({id:2005004002,title:"同步记录",select:false,show:true,pagePath:"../fundsDataSynchronize/fundsDataSyncHistory/fundsDataSyncHistory.html",controllerPath:"../fundsDataSynchronize/fundsDataSyncHistory/fundsDataSyncHistoryCtrl.js",servicePath:"../fundsDataSynchronize/fundsDataSyncHistory/fundsDataSyncHistoryService.js",cssPath:"../fundsDataSynchronize/fundsDataSyncHistory/fundsDataSyncHistory.css"});
