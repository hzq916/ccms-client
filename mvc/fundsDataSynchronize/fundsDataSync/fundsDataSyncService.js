angular.module('cmsService').factory('fundsDataSyncService',function() {
	var service = {};
	...
	//查询资金数据同步详情
	service.getTatractFundsSyncDetail = function(params,callback) {
		cms.request("getTatractFundsSyncDetail",params,callback);
	}
